Candy.Felicitacion2 = function (game) {
};
Candy.Felicitacion2.prototype = {
    create: function () {
        ...
        // Adding animation
        var animationImages = [];
        this.rootName = 'recompensa2-juego2_fraseugo2';
        ...
        var sound = this.game.sound.play('audioRecompensa2');
