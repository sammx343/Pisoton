...
Candy.MainMenu.prototype = {
	create: function() {
		...
		//Adiciona imagen
		this.game.add.sprite(0, 0, 'LIANAS');
	
		//Adiciona imagen
		this.game.add.sprite(0, 0, 'PERSONAJES');
		
		//Adiciona imagen
		this.game.add.sprite(0, 0, 'ARBUSTOS');
    ...
    //
	startButton = this.add.button(640-401-10, 960-143-10, 'button-start', function(){this.game.state.start('Intro')}, this, 1, 0, 2);
