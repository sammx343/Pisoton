...
Candy.Puzzle.prototype = {
    create: function () {
        ...
        //this.base = this.game.add.sprite(760, 300, 'Rompecabezas');
    ...
    pieceDragStop: function (item) {
        ...
        if (this.totalDistance < 50) {
            ...
            if (this.piecesleft === 0)
                this.add.button(1500 * liScale, 935 * liScale, 'button-continue', function () { this.game.state.start('End') }, this, 1, 0, 2);
                //this.add.button(1270, 910, 'button-continue', function () { this.game.state.start('End') }, this, 1, 0, 2);
    ...
    pieceDragUpdate: function (item) {
        var liScale = 3;
        //item.position.setTo((item.x * liScale) / 0.7, (item.y * liScale) / 0.9);
