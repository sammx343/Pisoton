...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.10.13/css/jquery.dataTables.min.css"><!-- JavaScript -->
                    ...
                    success: function(mensaje)
                    {
                      //  alert(mensaje);
                        ...
                        if(obj.exito == "1")
                        {
                            ...
                            alertify.success('El contenido fue agregado éxitosamente');
                        }
                        else
                        {
                            $('#prueba').modal('show');
